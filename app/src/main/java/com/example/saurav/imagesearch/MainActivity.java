...
//        setSupportActionBar(toolbar);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(MainActivity.this, "Long Press For Details", Toast.LENGTH_SHORT).show();
            }
...
//        ProcessPhotos processPhotos = new ProcessPhotos("ocean",true);
//        processPhotos.execute();
//        GetRawData getRawData = new GetRawData("https://api.flickr.com/services/feeds/photos_public.gne?tags=android,nougat&format=json&nojsoncallback=1");
//        getRawData.execute();
//        GetFlickrJsonData jsonData = new GetFlickrJsonData("windows, redmond", true);
//        jsonData.execute();
    }
